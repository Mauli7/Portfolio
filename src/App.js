  ...
  return (
    <div className="min-h-screen bg-[#0a0f1a] text-white font-poppins relative overflow-hidden">
      ...
      <section id="home" className="h-screen flex items-center justify-between px-10 pt-20">
        <motion.div initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="w-1/2">
          ...
          <h3 className="text-3xl mt-4">And I'm a <span className="typing text-cyan-400"></span></h3>
          <p className="mt-6 text-lg text-gray-300 max-w-xl leading-relaxed">Passionate Frontend & Web Developer with 2+ years of experience. Skilled in HTML, CSS, JavaScript, Tailwind, React, and Node.js. ✨</p>
        ...
        <motion.div initial={{ opacity: 0, scale: 0.7 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8 }} className="w-1/2 flex justify-center">
     ...
     {/*  ABOUT SECTION */}
      ...
      {/* UPDATED: CONNECT ME (CONTACT SECTION) */}
      <section id="contact" className="py-24 px-10 bg-[#0a0f1a] text-center">
        <h2 className="text-5xl font-bold text-cyan-400 mb-10">Connect Me</h2>
